  ...
  <div class="container">
    <el-table :data="tableData" border stripe style="width: 100%">
      ...
      <el-table-column align="center" fixed="right" label="操作" width="120">
        <template #default="scope">
          <el-popconfirm title="确认同意吗？">
            <template #reference>
              <el-button link size="small" type="primary" @click="agree(scope.row.lid)">同意</el-button>
            </template>
          </el-popconfirm>
          <el-popconfirm title="确认拒绝吗？">
            <template #reference>
              <el-button link size="small" type="danger" @click="disagree(scope.row.lid)">拒绝</el-button>
            </template>
          </el-popconfirm>
        </template>
      </el-table-column>
